...
2. Can we create leakage-safe deterministic features?
3. Can a deterministic ranking baseline beat benchmarks after costs?
4. Only then: do simple ML baselines add value?
